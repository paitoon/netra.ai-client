...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuDetect = QtWidgets.QMenu(self.menuImage_Processing)
        ...
        self.actionRestricted_Area = QtWidgets.QAction(MainWindow)
        self.actionRestricted_Area.setObjectName("actionRestricted_Area")
        self.menuDetect.addAction(self.actionRestricted_Area)
        self.menuImage_Processing.addAction(self.actionFace_Recognition)
        self.menuImage_Processing.addAction(self.menuDetect.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionRestricted_Area.setText(_translate("MainWindow", "Restricted Area"))
